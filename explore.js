  ...
  var DATA = [
    {
      ...
      description: 'Public enterprise AI Catalog for agents, tools, skills, gateways, and AI resources exposed by example.com.',
      tags: ['enterprise', 'ai-catalog', 'public-agent-discovery'],
    ...
    },
    {
      ...
      description: "Federated AI Catalog entry pointing to SkyBlue's DNS-AID-based discovery path for its refunds agent.",
    ...
    },
    {
      ...
      description: 'Ordering agent for Moon Bakery. Supports menu lookup, order placement, pickup scheduling, and order status.',
    ...
    },
    {
      ...
      description: 'Personal agent associated with john@hotmail.com. Public metadata is minimal; private actions require user consent.',
    ...
    },
    {
      ...
      description: 'A distributed directory service for agent discovery: content-addressed storage, distributed routing (DHT-based), cryptographic signing and verification, and policy enforcement across domains.',
      tags: ['agntcy', 'dht', 'content-addressed'],
    ...
    },
    {
      ...
      description: 'A standard interface for querying and retrieving agentic resources across catalogs and registries.',
      tags: ['ard', 'finder-api'],
    ...
    },
    {
      ...
      description: 'Onboarding, lifecycle management, billing, observability, and compliance within its ecosystem. Bridged for cross-platform and cross-community discovery.',
    ...
    },
    {
      ...
      description: 'A controlled entry point that enforces authentication, authorization, rate limiting, and policy. Bridged for discovery of agents not behind that gateway.',
    ...
    },
    {
      ...
      description: 'An identity system for verifying ownership, provenance, and trust. Bridged for resource indexing and routing.',
